...
- You can place the location of the new AssetBundle under the `Remote BEE File Location` field, along with the `Unlock Password` provided in the `dontuploadmepassword.txt` file generated in the `/AssetBundles/` directory.
